...
import com.proyecto.forohub.domain.dto.ActualizacionUsuarioDTO;
import com.proyecto.forohub.domain.dto.ListarUsuariosDTO;
import com.proyecto.forohub.domain.dto.RespuestaUsuarioDTO;
...
public class UsuarioController {
    ...
    public ResponseEntity actualizacionUsuario (@RequestBody @Valid ActualizacionUsuarioDTO actualizacionUsuarioDTO){
        var usuario = usuarioRepository.getReferenceById(actualizacionUsuarioDTO.id());
